          ...
          >
            ...
            <div className="td_section_heading td_style_1">
              ...
              <p className="td_section_subtitle td_fs_18 mb-0 td_white_color td_opacity_7">
                From clubs and cultural fests to mentoring hubs and maker
                spaces, our campus blends learning with community, wellness,
                and fun—every day, for every student.
              </p>
            </div>
            ...
            <div className="row">
              <div className="col-sm-6">
                ...
                >
                  ...
                  <div className="td_card_info">
                    <h2 className="td_card_title mb-0 td_fs_18 td_semibold td_white_color">
                      <Link to="/course-details">Wellness & Recreation</Link>
                    </h2>
                    <Link to="/course-details" className="td_card_btn">
                      <svg
                        width="23"
              ...
              <div className="col-sm-6">
                ...
                >
                  <Link to="/course-details" className="td_card_thumb d-block">
                    <img
                      src={campusLife2}
                      alt="Arts & Cultural Programs"
                      className="w-100"
                    />
                  </Link>
                  <div className="td_card_info">
                    <h2 className="td_card_title mb-0 td_fs_18 td_semibold td_white_color">
                      <Link to="/course-details">Arts & Cultural Programs</Link>
                    </h2>
                    <Link to="/course-details" className="td_card_btn">
                      <svg
                        width="23"
                ...
                >
                  <Link to="/course-details" className="td_card_thumb d-block">
                    <img
                      src={campusLife4}
                      alt="Sports & Fitness Facilities"
                      className="w-100"
                    />
                  </Link>
                  <div className="td_card_info">
                    <h2 className="td_card_title mb-0 td_fs_18 td_semibold td_white_color">
                      <Link to="/course-details">Sports & Fitness Facilities</Link>
                    </h2>
                    <Link to="/course-details" className="td_card_btn">
                      <svg
                        width="23"
