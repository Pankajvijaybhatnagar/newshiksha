...
// Import images from heroslider
import img1 from "../../assets/img/heroslider/k1.jpeg";
import img2 from "../../assets/img/heroslider/k2.jpeg";
import img3 from "../../assets/img/heroslider/k3.jpg";
import img4 from "../../assets/img/heroslider/k4.jpeg";
import img5 from "../../assets/img/heroslider/k4.jpg";
...
function ImageSlider() {
  ...
  return (
    <div style={{ width: "100%", maxWidth: "950px", height: "75vh", margin: "0 auto 32px auto", borderRadius: "18px", overflow: "hidden", boxShadow: "0 8px 32px rgba(137,12,37,0.13)", background: "#eee", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
      <img src={sliderImages[current]} alt={`Conference Slide ${current + 1}`} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
