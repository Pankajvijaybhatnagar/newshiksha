        ...
        <div className="td_footer_row">
          ...
          <div className="td_footer_col">
            <div className="td_footer_widget">
              ...
              <ul className="td_footer_widget_menu">
                ...
                <li>
                  <Link href="/upcoming-event">Upcoming Events</Link>
                </li>
                 <li>
                  <Link href="/academic_Council">Academic Council</Link>
                </li>
                <li>
          ...
          <div className="td_footer_col">
            <div className="td_footer_widget">
              ...
              <ul className="td_footer_widget_menu">
                <li>
                  <Link href="/past-event">Past Events</Link>
                </li>
                <li>
