...
// Use public folder for images in Next.js
const heroBg = "/assets/img/home_1/hero_bg.jpg";
...
export const HeroOne = () => {
  ...
  <div className="td_hero_btn_group">
    <Link href="https://shikshamahakumb.co.in/registration" className="td_btn td_style_1 td_radius_10 td_medium td_fs_20 wow fadeInUp" data-wow-duration="0.9s" data-wow-delay="0.35s" target="_blank" rel="noopener noreferrer">
      <span className="td_btn_in td_white_color td_accent_bg">
    ...
    <Link href="https://shikshamahakumb.co.in/exhibition" className="td_btn td_style_1 td_radius_10 td_medium td_fs_20 wow fadeInUp" data-wow-duration="0.9s" data-wow-delay="0.35s" target="_blank" rel="noopener noreferrer">
      <span className="td_btn_in td_white_color td_accent_bg">
