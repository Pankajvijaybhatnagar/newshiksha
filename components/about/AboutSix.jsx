...
const aboutImg1 = "/assets/img/home_6/about_img_1.jpg";
const aboutImg2 = "/assets/img/home_6/about_img_2.jpg";
const aboutIcon1 = "/assets/img/home_6/about_icon_1.svg";
...
export const AboutSix = () => {
  ...
  const ScrollingLogos = ({ logos, direction = 'left', speed = 'slow' }) => {
    ...
    return (
      <div style={{ overflow: 'hidden', padding: '20px 0' }}>
        <div 
          className={`scrolling-logos ${direction === 'right' ? 'scroll-right' : 'scroll-left'} ${speed === 'fast' ? 'speed-fast' : speed === 'medium' ? 'speed-medium' : 'speed-slow'}`}
          style={{ 
            display: 'flex', 
            gap: '30px',
            width: 'fit-content',
      ...
      <section style={{ padding: '80px 0', backgroundColor: '#f8f9fa' }}>
        <div className="container">
          ...
          <div style={{ marginBottom: '60px' }}>
            ...
            <ScrollingLogos logos={academicPartners} direction="left" speed="slow" />
          </div>
          ...
          <div style={{ marginBottom: '60px' }}>
            ...
            <ScrollingLogos logos={mediaPartners} direction="right" speed="medium" />
          </div>
          ...
          <div style={{ marginBottom: '60px' }}>
            ...
            <ScrollingLogos logos={sponsors} direction="left" speed="fast" />
          </div>
        </div>
      </section>
